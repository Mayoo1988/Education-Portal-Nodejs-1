...
class UserRoleMapping {
  UserRoleMappingInDB ( UserId,RoleId,IsActive,Createdby,CreatedOn,UpdatedBy,UpdatedOn) {
    return new Promise(async (resolve, reject) => {
      try {
        await db.UserRoleMapping.create({
            UserID: UserId,
            RoleId:RoleId,
            IsActive:IsActive,
            CreatedBy:Createdby,
...
const UserRoleMappingdata = async (req, res) => {
  try {
    ...
    const UserRoleCls = new UserRoleMapping()
  ...
  //  console.log(passedUserId)
    ...
    const userUpdate = await UserRoleCls.UserRoleMappingInDB(UserId,RoleId,IsActive, createdby, createdon,updatedby,updatedon)
...
module.exports = { UserRoleMappingdata }
